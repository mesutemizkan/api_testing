...
import test_data.OpenWeatherTestData;
import static io.restassured.RestAssured.*;
import static org.junit.Assert.assertEquals;

public class GetRequest10Suleyman extends OpenWeatherBaseUrl {
    ...
    */
    ...
    public void get01() {
        ...
        OpenWeatherTestData expectedData = new OpenWeatherTestData();
        ...
        assertEquals(expectedData.expectedDataSetUp().get("visibility"), json.get("visibility"));
    }
